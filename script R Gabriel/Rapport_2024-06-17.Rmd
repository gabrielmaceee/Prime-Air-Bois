...
author: "Jeu de données data_afdm"
output:
  html_document: default
---
Ce jeu de données contient 31 individus et 11 variables, 1 variable qualitative est illustrative.

- - -

```{r, echo = FALSE}
library(FactoMineR)
load('C:/Users/gmace/PAB/Projet Bois-buche/script R Gabriel/Workspace.RData')
```
...
Les 2 premiers axes de l' analyse expriment **58.17%** de l'inertie totale du jeu de données ; cela signifie que 58.17% de la variabilité totale du nuage des individus (ou des variables) est représentée dans ce plan.
...
Cette valeur est supérieure à la valeur référence de **40.88%**, la variabilité expliquée par ce plan est donc significative
(cette intertie de référence est le quantile 0.95-quantile de la distribution des pourcentages d'inertie obtenue en simulant 3356 jeux de données aléatoires de dimensions comparables sur la base d'une distribution normale).
...
Ces composantes révèlent un taux d'inertie supérieur à celle du quantile 0.95-quantile de distributions aléatoires (76.63% contre 55.05%).
...
```{r, echo = FALSE, fig.align = 'center', fig.height = 3.5, fig.width = 5.5}
drawn <-
c("28", "14", "15", "9", "7", "29", "25", "10", "30", "19", "27", 
"22", "11", "12", "21", "17", "23", "5")
