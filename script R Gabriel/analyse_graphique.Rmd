...
# Évolution du nombre de dossier par territoire:
...
plot(table(format(res_M, "%Y"))[-c(1,10)], ylab = "", type = "l", col ="blue", main = "évolution du nombre de demande par an par territoire")
lines(table(format(res_G, "%Y"))[-c(1,10)], type = "l", col ="red")
lines(table(format(res_V, "%Y"))[-9], type = "l", col ="green")
legend("topleft", legend=c("Grenoble Métropole", "Grésivaudan", "Pays Voironnais"),
       col=c("blue", "red", "green"), lty=1, cex=0.8,  bg="transparent")

plot(table(format(res_V, "%Y"))[-9]/ length(res_V[-9]), ylab = "", type = "l", col ="green", main = "évolution de la demande / demande totale par territoire")
...
plot(100 * table(format(data[data$Territoire == "CAPV" & data$refusé,]$dossier_reçu, "%Y"))[-9] / table(format(data[data$Territoire == "CAPV",]$dossier_reçu, "%Y"))[-9], type = "l", col ="green", ylab = "",
...
# Évolution part de majoration

```{r}
plot(table(format(data[data$majoration == "M" ,]$dossier_reçu, "%Y/%m"))/ table(format(data$dossier_reçu, "%Y/%m"))[-1], type = "l", col ="green",  main = "évolution de la part de prime majorées en général", las = 2,  ylab = "",cex.axis=1)
plot(table(format(data$dossier_reçu, "%Y/%m"))[-1], type = "l", col ="blue", ylab = "",  main = "évolution de la prime en général")
...
t2 <- t2[sorted_indices]
t <- as.table(t2)
plot(t/ table(format(data[data$Territoire == "CCLG", ]$dossier_reçu, "%Y/%m"))[-1], type = "l",  ylab = "", col ="green",  main =  "évolution de la part de prime majorées au Grésivaudan", cex.names = 0.5)
plot(table(format(data[data$Territoire == "CCLG", ]$dossier_reçu, "%Y/%m"))[-1], type = "l", ylab = "", col ="blue",  main =  "évolution de la prime au Grésivaudan")
...
t2 <- t2[sorted_indices]
t <- as.table(t2)
plot(t/ table(format(data[data$Territoire == "GAM", ]$dossier_reçu, "%Y/%m")), type = "l", ylab = "", col ="green",  main =  "évolution de la part de prime majorées à Grenoble")
plot(table(format(data[data$Territoire == "GAM", ]$dossier_reçu, "%Y/%m")), type = "l", ylab = "", col ="blue",  main =  "évolution de la prime à Grenoble")
lines(t, col = "green", type = "l")
legend("topleft", legend=c("majorées", "totale"),   col=c("green", "blue"), lty=1, cex=0.8)
...
t2 <- t2[sorted_indices]
t <- as.table(t2)
plot(t[-96] / table(format(data[data$Territoire == "CAPV", ]$dossier_reçu, "%Y/%m"))[-96], type = "l", col ="green",  ylab = "", main =  "évolution de la part de prime majorées Pays Voironais")
plot( table(format(data[data$Territoire == "CAPV", ]$dossier_reçu, "%Y/%m")), type = "l", col ="blue",  ylab = "", main =  "évolution de la prime Pays Voironais")
lines(t, col = "green", type = "l")
legend("topleft", legend=c("majorées", "totale"),   col=c("green", "blue"), lty=1, cex=0.8)
```
...
```{r}
plot(table(format(data[data$majoration == "M" ,]$transfert_facture, "%Y"))[-1]/ table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col ="green",  main = "évolution de la part de prime majorées en général", las = 2, ylab = "", cex.axis=1)
plot(table(format(data$transfert_facture, "%Y"))[-c(1,2,3,12)], type = "l", ylab = "", col ="blue",  main = "évolution de la prime en général")
lines(table(format(data[data$majoration == "M" ,]$transfert_facture, "%Y"))[-1], col = "green", type = "l")
legend("topleft", legend=c("majorées", "totale"),   col=c("green", "blue"), lty=1, cex=0.8)

plot(table(format(data[data$majoration == "M" & data$Territoire == "CCLG" ,]$transfert_facture, "%Y")) / table(format(data[data$Territoire == "CCLG", ]$transfert_facture, "%Y")), type = "l",  col ="red",  main =  "évolution de la part de prime majorées par territoire", cex.names = 0.5, ylab = "", ylim = c(0,0.4))
...
plot(table(format(data[data$Territoire == "CCLG", ]$transfert_facture, "%Y"))[-1], type = "l", col ="blue",  ylab = "", main =  "évolution de la prime au Grésivaudan")
lines(table(format(data[data$majoration == "M" & data$Territoire == "CCLG" ,]$transfert_facture, "%Y")), col = "green", type = "l")
legend("topleft", legend=c("majorées", "totale"),   col=c("green", "blue"), lty=1, cex=0.8)

plot(table(format(data[data$Territoire == "GAM", ]$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col ="blue",  ylab = "", main =  "évolution de la prime à Grenoble")
lines(table(format(data[data$majoration == "M" & data$Territoire == "GAM" ,]$transfert_facture, "%Y"))[-1], col = "green", ylab = "", type = "l")
legend("topleft", legend=c("majorées", "totale"),   col=c("green", "blue"), lty=1, cex=0.8)

plot( table(format(data[data$Territoire == "CAPV", ]$transfert_facture, "%Y")), type = "l", col ="blue", ylab = "",  main =  "évolution de la prime Pays Voironais")
...
# Changement de type de combustible :
changement de type de mode chauffage : buche -> buche, buche -> granulé, granulé -> granulé, granulé -> buche, en fonction des années
```{r}
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Bûche" ,]$dossier_reçu, "%Y"))[-c(1,11)],ylab = "", type = "l", col ="black", main = "évolution de bûche vers bûche")
...
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Granulés" ,]$dossier_reçu, "%Y"))[-c(10)], ylab = "", type = "l", col ="black", main = "évolution de bûche vers granulés")
...
plot(table(format(data[data$Type.combustible == "Granulés" & data$Type.combustible.nouveau.materiel == "Granulés" ,]$dossier_reçu, "%Y"))[-c(8)], ylab = "", type = "l", col ="black", main = "évolution de granulés vers granulés")
...
```{r}
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Bûche",]$dossier_reçu, "%Y"))[-c(1,11)] / table(format(data$dossier_reçu, "%Y"))[-c(1,11)], type = "l", col ="pink",  ylab = "",main = "évolution des taux de changement de type de combustible")
...
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Bûche" & data$Territoire == "GAM" ,]$dossier_reçu, "%Y"))[-c(10)] / table(format(data[data$Territoire == "GAM" ,]$dossier_reçu, "%Y"))[-c(10)], type = "l", col ="pink", ylab = "", main = "évolution des taux de changement de type de combustible GAM")
...
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Bûche" & data$Territoire == "CCLG"  ,]$dossier_reçu, "%Y"))[-c(1)] / table(format(data[data$Territoire == "CCLG"  ,]$dossier_reçu, "%Y"))[-1], type = "l", col ="pink", ylab = "", main = "évolution des taux de changement de type de combustible CCLG")
...
plot(table(format(data[data$Type.combustible == "Bûche" & data$Type.combustible.nouveau.materiel == "Bûche" & data$Territoire == "CAPV" ,]$dossier_reçu, "%Y"))[-c(9)] / table(format(data[ data$Territoire == "CAPV" ,]$dossier_reçu, "%Y"))[-9], type = "l", col ="pink", ylab = "", main = "évolution des taux de changement de type de combustible CAPV")
...
# Part de dossier par tranche de revenus : 
...
color = colfunc(9)
plot(table(format(data[data$Revenus == "Moins de 20 000 €",]$transfert_facture, "%Y")) / table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[1], ylim = c(0, 0.3), ylab = "", main = "évolution de la part de dossier par tranche de revenus")
i = 2
for(n in revenus){
...
# plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == "GAM",]$transfert_facture, "%Y")) / table(format(data[data$Territoire == "GAM",]$transfert_facture, "%Y")), type = "l", col = color[1], lty = 1, ylim = c(0, 0.3), ylab = "", main = glue("évolution de la part de dossier par tranche de revenus GAM"))
# i = 2
# for(n in revenus){
...
# legend("topright", legend=c("Moins de 20 000 €", revenus),  col = color[1:(length(unique(data$Revenus))-1)], lty=1, cex=0.5, bg="transparent")
# 
# plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == "CCLG",]$transfert_facture, "%Y")) / table(format(data[data$Territoire == "CCLG",]$transfert_facture, "%Y"))[-1], type = "l", col = color[1], lty = 1, ylim = c(0, 0.3), ylab = "", main = glue("évolution de la part de dossier par tranche de revenus CCLG"))
# i = 2
# for(n in revenus){
...
colfunc<-colorRampPalette(c("cyan","green","blue"))
color = colfunc(5)
plot(table(format(data[data$Revenus == "Moins de 20 000 €",]$transfert_facture, "%Y")) / table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[1], ylim = c(0, 0.5), ylab = "", main = "évolution de la part de dossier par tranche de revenus")
for(i in 1:4){
  if(i == 1) lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] ,]$transfert_facture, "%Y"))[-c(1,2)]/ table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
  else if(i == 4) lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] ,]$transfert_facture, "%Y"))[-c(1)]/ table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
  else lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] ,]$transfert_facture, "%Y"))/ table(format(data$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
}
legend("topright", legend=leg,  col = color[1:5], lty=1, cex=0.5, bg="transparent")


plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == "GAM",]$transfert_facture, "%Y")) / table(format(data[data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[1], lty = 1, ylim = c(0, 0.5), ylab = "", main = glue("évolution de la part de dossier par tranche de revenus GAM"))
for(i in 1:4){
  if(i == 1) lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] & data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1,2)]/ table(format(data[data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
  else if(i == 4) lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] & data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1)]/ table(format(data[data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
  else lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] & data$Territoire == "GAM",]$transfert_facture, "%Y"))/ table(format(data[data$Territoire == "GAM",]$transfert_facture, "%Y"))[-c(1,2,3)], type = "l", col = color[i+1])
}
legend("topright", legend=leg,  col = color[1:5], lty=1, cex=0.5, bg="transparent")


plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == "CCLG",]$transfert_facture, "%Y")) / table(format(data[data$Territoire == "CCLG",]$transfert_facture, "%Y")), type = "l", col = color[1], lty = 1, ylim = c(0, 0.5), ylab = "", main = glue("évolution de la part de dossier par tranche de revenus CCLG"))
for(i in 1:4){
lines(table(format(data[data$Revenus %in% revenus[(2*i): (2*i+1)] & data$Territoire == "CCLG",]$transfert_facture, "%Y"))/ table(format(data[data$Territoire == "CCLG",]$transfert_facture, "%Y")), type = "l", col = color[i+1])
}
legend("topright", legend=leg,  col = color[1:5], lty=1, cex=0.5, bg="transparent")
```
...
colfunc<-colorRampPalette(c("cyan","green","blue"))
color = colfunc(9)
plot(table(format(data[data$Revenus == "Moins de 20 000 €" ,]$transfert_facture, "%Y")), type = "l", col = color[1], ylim=c(0,200), ylab = "", main = "évolution du nb de dossier par tranche de revenus")
...
for(t in unique(data$Territoire)[-3]){
  plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == t,]$transfert_facture, "%Y")) , type = "l", col = color[1],  ylim = c(0, 110), ylab = "", main = glue("évolution du nb de dossier par tranche de revenus à {t}"))
...
colfunc<-colorRampPalette(c("cyan","green","blue"))
color = colfunc(5)
plot(table(format(data[data$Revenus == "Moins de 20 000 €" ,]$transfert_facture, "%Y")), type = "l", col = color[1], ylim=c(0,350), ylab = "", main = "évolution du nb de dossier par tranche de revenus")

for(i in 1:4){
lines(table(format(data[data$Revenus %in% revenus[(2*i):(2*i+1)] ,]$transfert_facture, "%Y")) ,col = color[i+1], type = "l")
}
legend("topleft", legend= leg,  col = color[1:(length(unique(data$Revenus))-1)], lty=1, cex=0.5, bg="transparent")

for(t in unique(data$Territoire)[-3]){
  plot(table(format(data[data$Revenus == "Moins de 20 000 €" & data$Territoire == t,]$transfert_facture, "%Y")) , type = "l", col = color[1],  ylim = c(0, 200), ylab = "", main = glue("évolution du nb de dossier par tranche de revenus à {t}"))
...
colfunc<-colorRampPalette(c("cyan","green","blue"))
color = colfunc(9)
plot(table(format(data[data$Revenus == "20 000 à 30 000 €" ,]$transfert_facture, "%m")), type = "l", col = color[1], lty = 2, ylim=c(0,150), ylab = "", main = "évolution du nb de dossier par mois par tranche de revenus")
i = 2
for(n in sort(unique(data$Revenus))[-c(1,9)]){
lines(table(format(data[data$Revenus == n ,]$transfert_facture, "%m")) ,col = color[i], type = "l")
  i = i +1
}
legend("topleft", legend=sort(unique(data$Revenus))[-9],  col=color[1:(length(unique(data$Revenus))-1)], lty=c(2,rep(1,8)), cex=0.5, bg="transparent")

for(t in unique(data$Territoire)[-3]){
plot(table(format(data[data$Revenus == "20 000 à 30 000 €" & data$Territoire == t,]$transfert_facture, "%m")) , type = "l", col = color[1], lty = 2, ylim = c(0, 90), ylab = "", main = glue("évolution du nb de dossier par mois par tranche de revenus à {t}"))
i = 2
for(n in sort(unique(data$Revenus))[-c(1,9)]){
lines(table(format(data[data$Revenus == n & data$Territoire == t,]$transfert_facture, "%m")), type = "l", col = color[i])
  i = i +1
}
legend("topleft", legend=sort(unique(data$Revenus))[-9],  col=color[1:(length(unique(data$Revenus))-1)], lty=c(2,rep(1,8)), cex=0.5, bg="transparent")
}
...
# Taux de foyers ouverts : 

```{r}
plot(table(format(data[data$Type.Ancien.appareil == "Foyer ouvert" ,]$dossier_reçu, "%Y"))[-1], type = "l", col = 1, lty = 2, ylab = "", main = "évolution du nb de dossier foyer ouvert")
plot(table(format(data[data$Type.Ancien.appareil == "Foyer ouvert" ,]$dossier_reçu, "%Y"))[-1] / table(format(data$dossier_reçu, "%Y"))[-1], type = "l", col = 1, lty = 2, ylab = "", main = "évolution du taux de foyers ouverts dans les dossiers par an")
plot(table(format(data[data$Type.Ancien.appareil == "Foyer ouvert" ,]$dossier_reçu, "%Y/%m"))[-1] / table(format(data$dossier_reçu, "%Y/%m"))[-1], type = "l", col = 1, lty = 1, ylab = "", main = "évolution du taux de foyers ouverts dans les dossiers par mois")
```
